...
aws cloudwatch put-metric-data --metric-name file-exists --dimensions Instance=j-3GR8OE0FH0VLQ  --namespace "$NAMESPACE" --value $FILE_EXISTS
aws cloudwatch put-metric-data --metric-name file-updated --dimensions Instance=j-3GR8OE0FH0VLQ  --namespace "$NAMESPACE" --value $FILE_UPDATED